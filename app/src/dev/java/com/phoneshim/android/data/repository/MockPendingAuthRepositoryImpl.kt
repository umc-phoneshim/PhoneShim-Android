...
class MockPendingAuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun logout(): Result<Unit> = runCatching { tokenDataSource.clear() }

    override suspend fun recoverWithdrawal(identity: SocialIdentity): Result<AuthUser> = runCatching {
