...
@Singleton
class UnavailablePendingAuthRepository @Inject constructor() : PendingAuthRepository {
    ...
    ): Result<SocialLoginResult> = Result.failure(
        AuthException.FeatureUnavailable(PendingAuthFeature.RECOVER_WITHDRAWAL),
    )
